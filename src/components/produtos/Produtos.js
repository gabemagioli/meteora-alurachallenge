        ...
        <>
            <main>
                ...
                <ul className="content-center">
                    <h2 className="lg:mt-[60px] lg:ml-[0px] lg:text-center lg:text-3xl lg:font-medium lg:mb-[25px] sm:leading-[33.89] sm:font-[500] sm:text-[28px] sm:mt-[-400px] sm:ml-[-170px]">Produtos que estao bombando!</h2>
                    <div className="flex flex-row flex-wrap pl-[165px] pr-[165px] sm:ml-[-125px] sm:mt-[-400px] md:ml-[0px] md:mt-[0px]">
