...
function Footer () {
    return(
        ...
        <div className="flex flex-row justify-center">
            <input type="text"  id="cadastro" placeholder="Digite seu email" className="p-[10px] border-black border-r-0 border-solid border-[1px] mt-[24px] md:h-[38px] sm:h-[80px] md:w-[500px] md:mb-[17px] sm:w-[234px]"/>
